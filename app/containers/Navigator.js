    ...
    return (
      ...
      <div className="sidenav flex-col-sm-3 no-gutter">
              <ul>
                  ...
                  <NavigationItem path={"/alerts"} current={this.props.location.pathname} name="Alerts" description="Adjust notifications" />
                  <NavigationItem path={"/stocks"} current={this.props.location.pathname} name="Stock Alerts" description="Adjust stock alerts" />
